...
public class sex_MarketPlugin extends BaseSubmarketPlugin {
    ...
    public void updateCargoPrePlayerInteraction() {
        ...
        if (this.okToUpdateShipsAndWeapons()) {
            ...
            try {
                JSONObject stingerData =Global.getSettings().getMergedJSONForMod("data/config/sex_market.json","hakkari2");
    ...
    public String getTooltipAppendix(CoreUIAPI ui) {
        return ui.getTradeMode() == CampaignUIAPI.CoreUITradeMode.SNEAK ? "Requires: proper docking authorization (transponder on)" : super.getTooltipAppendix(ui);
    }
