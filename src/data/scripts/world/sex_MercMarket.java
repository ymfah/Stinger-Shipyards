...
public class sex_MercMarket extends BaseSubmarketPlugin {
    ...
    public void updateCargoPrePlayerInteraction() {
        ...
        if (this.okToUpdateShipsAndWeapons()) {
            ...
            try {
                JSONObject stingerData =Global.getSettings().getMergedJSONForMod("data/config/sex_merc_market.json","hakkari2");
    ...
    public boolean isEnabled(CoreUIAPI ui) {
        ...
        if (commissionFactionId != null && commissionFactionId.equals("sex_co")) {
    ...
    public String getTooltipAppendix(CoreUIAPI ui) {
        // Check if the player has the required commission with the specified faction
        boolean hasRequiredCommission = "sex_co".equals(Misc.getCommissionFactionId());

        if (!hasRequiredCommission) {
            return "Requires a SEx Co. commission.";
        }
    ...
    public String getIllegalTransferText(CargoStackAPI stack, SubmarketPlugin.TransferAction action) {
        return "SEx Co. does not do buybacks or refunds.";
    }
    ...
    public Highlights getTooltipAppendixHighlights(CoreUIAPI ui) {
        ...
        if (!hasRequiredCommission) {
            ...
            p.setText("Requires a SEx Co. commission.");
        ...
        if (!isEnabled(ui)) {
            ...
            j.setText("Requires a SEx Co. commission.");
