...
public class sex_branch extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {

	//@Override
	//public boolean isHidden() {
	//	return !market.getFactionId().equals("sex_co");
	//}

	//@Override
	//public boolean isFunctional() {
	//	return super.isFunctional() && market.getFactionId().equals("sex_co");
	//}

	@Override
	public boolean isHidden() {
	String factionId = market.getFactionId();
		return super.isHidden() && (factionId.equals
				(Factions.INDEPENDENT) ||
				factionId.equals(Factions.HEGEMONY) ||
				factionId.equals("ironshell") ||
				factionId.equals("es_mechanicus"));
	}
	
	@Override
	public boolean isFunctional() {
		String factionId = market.getFactionId();
		return super.isFunctional() && (factionId.equals
				(Factions.INDEPENDENT) ||
				factionId.equals(Factions.HEGEMONY) ||
				factionId.equals("ironshell") ||
				factionId.equals("es_mechanicus"));
	...
	public void apply() {
		super.apply(true);
				...
				if (isFunctional()) {
					if (!market.hasSubmarket("sex_market") && !market.isPlayerOwned()) {
						market.addSubmarket("sex_market");
						SubmarketAPI sub = market.getSubmarket("sex_market");
						sub.setFaction(Global.getSector().getFaction("sex_co"));
						Global.getSector().getEconomy().forceStockpileUpdate(market);
					}
				} else {
					market.removeSubmarket("sex_market");
				}
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "sex_co";
	}
